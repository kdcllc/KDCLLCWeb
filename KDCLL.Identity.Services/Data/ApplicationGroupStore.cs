...
using KDCLLC.Identity.Services.Data.Base;
...
namespace KDCLLC.Identity.Services.Data
{
    public class ApplicationGroupStore : IDisposable
    {
        ...
        public Task<ApplicationGroup> FindByIdAsync(int roleId)
        {
            this.ThrowIfDisposed();
        ...
        public ApplicationGroup FindById(int roleId)
        {
            this.ThrowIfDisposed();
        ...
        public Task<ApplicationGroup> FindByNameAsync(string groupName)
        {
            ...
            return QueryableExtensions
                .FirstOrDefaultAsync<ApplicationGroup>(this._groupStore.EntitySet,(ApplicationGroup u) => u.Name.ToUpper() == groupName.ToUpper());
        }
