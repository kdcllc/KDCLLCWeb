...
using KDCLLC.Identity.Services.ViewModels.Account;
    ...
    public partial class AccountController : Controller
    {
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //var body = WebUtility.HtmlEncode("Please confirm your account by clicking this link: <a href=\"" + callbackUrl + "\">link</a>");
        ...
        public virtual async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.UserName, Email = info.Email, FirstName = info.DefaultUserName };
        ...
        [HttpGet]
        [ActionName("LogOff")]
        public virtual ActionResult LogOff2()
        {
            AuthenticationManager.SignOut();
            return RedirectToAction("Index", "Home");
        }
